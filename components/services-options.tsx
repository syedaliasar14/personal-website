  ...
  return (
    <section className="mt-10 grid w-full gap-6 md:grid-cols-2">
      ...
      >
        ...
        <p className="mt-5 text-pill">Business websites</p>
        <h2 className="mt-3 text-3xl font-bold tracking-tight md:text-4xl">Get more customers with a site that actually converts.</h2>
